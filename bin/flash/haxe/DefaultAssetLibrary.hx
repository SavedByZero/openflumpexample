...
@:keep @:bind #if display private #end class __ASSET__assets_format2_flumptester_resources_xml extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_xml_flumptester_resources_xml extends flash.utils.ByteArray { }
